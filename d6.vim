...
exe 'vert 3resize ' . ((&columns * 167 + 94) / 188)
argglobal
balt input.txt
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists(fnamemodify("day6.py", ":p")) | buffer day6.py | else | edit day6.py | endif
balt day5.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
68
normal! zo
let s:l = 87 - ((13 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 87
