...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-ai,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vim91/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=5
set shiftwidth=2
set showcmd
set softtabstop=2
...
exe 'vert 1resize ' . ((&columns * 20 + 79) / 158)
exe '2resize ' . ((&lines * 41 + 40) / 80)
exe 'vert 2resize ' . ((&columns * 20 + 79) / 158)
exe 'vert 3resize ' . ((&columns * 137 + 79) / 158)
argglobal
balt input.txt
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists(fnamemodify("day7.py", ":p")) | buffer day7.py | else | edit day7.py | endif
balt day6.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
